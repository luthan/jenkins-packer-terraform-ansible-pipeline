...
resource "aws_iam_role_policy_attachment" "jenkins_server_EC2FullAccess_policy_attachment" {
  role       = aws_iam_role.jenkins_server.name
  policy_arn = data.aws_iam_policy.EC2FullAccess.arn
}

resource "aws_iam_role_policy_attachment" "jenkins_server_S3FullAccess_policy_attachment" {
  role       = aws_iam_role.jenkins_server.name
  policy_arn = data.aws_iam_policy.S3FullAccess.arn
}

resource "aws_iam_role_policy_attachment" "jenkins_server_IAMReadOnlyAccess_policy_attachment" {
  role       = aws_iam_role.jenkins_server.name
